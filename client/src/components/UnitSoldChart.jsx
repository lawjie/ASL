...
export default function UnitSoldChart(){
  ...
  const chartStyle = 'flex flex-col justify-center items-center bg-white p-4 h-full w-[30vw] border-2 border-blue-900 shadow-lg shadow-blue-900/50 rounded-3xl text-[#001f3e]'
  return (
    // MAIN DIV
